...
class PlaybackService : MediaLibraryService() {
    ...
    companion object {
        const val CMD_NEXT_CHAPTER = "com.frybynite.podlore.NEXT_CHAPTER"
        const val CMD_PREV_CHAPTER = "com.frybynite.podlore.PREV_CHAPTER"
...
private fun Episode.toMediaItem(podcastImageUrl: String?) = MediaItem.Builder()
    ...
    .setMediaMetadata(
        MediaMetadata.Builder()
            ...
            .setArtworkUri((imageUrl ?: podcastImageUrl)?.let { android.net.Uri.parse(it) })
            .build()
    ).build()
